...
class Doctor(parent_crud):
    ...
    Methods:
    add_doctor(self, name, DOB, qualifications, department_id, contact_number, gender, floor_number, no_nurses_in_help, username, nationality)
        Adds a doctor to the database.
    
    """

    def add_doctor(self, name, DOB, qualifications, department_id, contact_number, gender, floor_number, no_nurses_in_help, username, nationality, password, image):
        """
        Adds a doctor to the database.
        ...
        nationality (str): The nationality of the doctor.
        password (str): The password of the doctor.
        image (str): The image of the doctor.
    ...
    def create_multiple_filter(self, id=None, name=None, DOB=None, qualifications=None, department_id=None, contact_number=None, gender=None, floor_number=None, nurses_in_help=None, username=None, nationality=None, password=None, image=None):
        """
        ...
        username (str, optional): The username of the doctor.
        nationality (str, optional): The nationality of the doctor.
        password (str, optional): The password of the doctor.
        image (str, optional): The image of the doctor.
    ...
    def read_one(self, id=None, name=None, DOB=None, qualifications=None, department_id=None, contact_number=None, gender=None, floor_number=None, no_nurses_in_help=None, username=None, nationality=None, password=None, image=None, filter=None):
        if filter is None:
            filter = self.create_multiple_filter(id, name, DOB, qualifications, department_id, contact_number, gender, floor_number, no_nurses_in_help, username, nationality, password, image)
        return self._read_one(filter, self.doctor)

    def read_all_by_filter(self, id=None, name=None, DOB=None, qualifications=None, department_id=None, contact_number=None, gender=None, floor_number=None, no_nurses_in_help=None, username=None, nationality=None, password=None, image=None, filter=None):
        """
...
if __name__ == '__main__':
    ...
    print(doctor.add_doctor(
        ...
        "https://example.com/doctor1.jpg"  # Add image when creating a doctor
    ))
