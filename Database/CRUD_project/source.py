...
class Patient:
    ...
    def create_patient_doc(self,name, age, disease, room_no, medicines, gender):
        patient_document = {
            "name": name,
            "age": age,
            "disease": disease,
...
steven=Patient()
# steven.create_patient_doc("mina", 21, "Anger", "D112", ["ketofan", "dalflon"], "male")
patients = [
    {
        "name": "Steven",
        "age": 21,
...
class Nurse:
    ...
    def create_nurse_doc(self, name, age, qualifications, department_id, contact_number, gender,floor_number):
        nurse_document = {
            "name": name,
            "age": age,
...
class Doctor:
    ...
    def create_doctor_doc(self, name, age, qualifications, department_id, contact_number, gender,floor_number,no_nurses_in_help):
        doctor_document = {
            "name": name,
            "age": age,
            "qualifications": qualifications,
...
# Creating a nurse document using the test data
# steven.create_doctor_doc("pola",30,"RN,BSN" ,"Nursing Department","123-456-7890","Female",2,5)
