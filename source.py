...
class Patient:
    ...
    def create_patient_doc(self,name,dob,age,gender,Nationality, room_no, disease, medicines, Priority_Care,Medical_Desc,image_path,Bimage):
        patient_document = {
            "name": name,
            "DOB": dob,
            "age": age,
        ...
        print("Patient_ID: ", patient_inserted_id)
        return patient_inserted_id
